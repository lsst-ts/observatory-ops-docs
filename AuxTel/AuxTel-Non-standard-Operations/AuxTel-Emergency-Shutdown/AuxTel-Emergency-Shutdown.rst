.. _Weather constraints: https://obs-ops.lsst.io/Observing-Constraints/AuxTel-Observing-Constraints/AuxTel-Weather-Constraints-index.html
...
.. _AuxTel-Non-Standard-Operations-AuxTel-Non-standard-Operations: 
...
With **EXTREME CAUTION** slide the switch labeled "CLOSE" (yellow arrow) progresivily to the left. This is a low-level control switch and there are no limit switches or fail-safes. It is best to stop the shutter movement about 1 cm before it is fully closed to prevent you over drive the shutter until it bangs into the lower shutter or cause damage on the drive.

.. _Title-of-Procedure-Critical-Step-2:
