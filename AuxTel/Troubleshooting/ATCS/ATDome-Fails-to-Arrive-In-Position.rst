...
The dome tracking and positioning can be recovered from LOVE. In case this fails, 
you can use a notebook to issue commands and recover the dome position and following. 
