...
.. list-table:: AT Control Cabinet
   ...
   * - 2
     - Powerbar + Hexapod
..
`Link to AT Control Cabinet <http://aux-pdu-tcs.cp.lsst.org>`_
...
.. list-table:: Spectrograph Power Switch Cabinet
   ...
   * - 2
     - Power and cRIO
..
`Link to Spectrograph Power Switch Cabinet <http://aux-pdu-spectrograph.cp.lsst.org>`_
...
.. list-table:: Dome Main Control Box
   ...
   * - 2
     - Empty
..
`Link to Dome Main Control Box <http://aux-pdu-dome.cp.lsst.org>`_
...
.. list-table:: Illumination System
   ...
   * - 8
     - Chiller
..
`Link to Illumination System <http://auxtel-illpdu.cp.lsst.org/>`_
