...
.. list-table::
   ...
   * - AT daytime checkouts
     - | **LATISS:**
       ...
       | `ts_standardscripts/daytime_checkout/latiss_checkout.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/daytime_checkout/latiss_checkout.py>`_ 
       |
       | **ATPneumatics:**
       | ``auxtel/daytime_checkout/atpneumatics_checkout.py``
       | `ts_standardscripts/daytime_checkout/atpneumatics_checkout.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/daytime_checkout/atpneumatics_checkout.py>`_ 
       |
       | **Telescope and Dome:**
       | ``auxtel/daytime_checkout/telescope_and_dome_checkout.py``
       | `ts_standardscripts/daytime_checkout/telescope_and_dome_checkout.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/daytime_checkout/telescope_and_dome_checkout.py>`_ 
       |
       | **Slew and Take Image:**
       | ``auxtel/daytime_checkout/slew_and_take_image_checkout.py``
       | `ts_standardscripts/daytime_checkout/slew_and_take_image_checkout.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/daytime_checkout/slew_and_take_image_checkout.py>`_ 
     - No configurations
   * - AT ``prepare_for`` sequences
     - | **Venting:**
       | ``auxtel/prepare_for/vent.py``
       | `ts_standardscripts/prepare_for/vent.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/prepare_for/vent.py>`_ 
       |
       | **Flats:**
       | ``auxtel/prepare_for/flat.py``
       | `ts_standardscripts/prepare_for/flat.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/prepare_for/flats.py>`_ 
       |
       | **On Sky:**
       | ``auxtel/prepare_for/onsky.py``
       | `ts_standardscripts/prepare_for/onsky.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/prepare_for/onsky.py>`_ 
       |
       | **CO2 Clean-Up:**
       | ``auxtel/prepare_for/co2_cleanup.py``
       | `ts_standardscripts/prepare_for/co2_cleanup.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/prepare_for/co2_cleanup.py>`_ 
     - No configurations  
   * - AT shutdown sequence
     - | ``auxtel/shutdown.py``
       | `ts_standardscripts/data/scripts/auxtel/shutdown.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/shutdown.py>`_
     - No configurations
...
.. list-table::
   ...
   * - 
     ...
     - | **Enable:** 
       ...
       | `ts_standardscripts/data/scripts/auxtel/enable_atcs.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/enable_atcs.py>`_
       |
       | **Standby:** 
       | ``auxtel/standby_atcs.py``
       | `ts_standardscripts/data/scripts/auxtel/standby_atcs.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/standby_atcs.py>`_
     - No configurations
   * - 
     - Apply offsets to the ATCS
     - | ``auxtel/offset_atcs.py``
       | `ts_standardscripts/data/scripts/auxtel/offset_atcs.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/offset_atcs.py>`_
     - 
       .. dropdown:: SAL Script
   ...
   * - **ATPtg**
     ...
     - | ``auxtel/point_azel.py``
       | `ts_standardscripts/data/scripts/auxtel/point_azel.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/point_azel.py>`_
     -      
       .. dropdown:: SAL Script
   ...
   * - 
     ...
     - | **Enable:**
       ...
       | `ts_standardscripts/atdome/track_target.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/track_target.py>`_
       |
       | **Disable:**
       | ``auxtel/stop_tracking.py``
       | `ts_standardscripts/atdome/stop_tracking.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/stop_tracking.py>`_
     -
       .. dropdown:: SAL Script
   ...
   * - **ATDome**
     ...
     - | **Open:**
       ...
       | `ts_standardscripts/atdome/open_dome.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/open_dome.py>`_
       |
       | **Close:**
       | ``auxtel/atdome/close_dome.py``
       | `ts_standardscripts/atdome/close_dome.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/close_dome.py>`_
     -  
       .. dropdown:: SAL Script
   ...
   * - 
     ...
     - | **Open:**
       ...
       | `ts_standardscripts/atdome/open_dropout_door.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/open_dropout_door.py>`_
       |
       | **Close:**
       | ``auxtel/atdome/close_dropout_door.py``
       | `ts_standardscripts/atdome/close_dropout_door.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/close_dropout_door.py>`_

       .. note::
         The dropout shutter should be opened when the winds speeds are low :math:`(< 8\,\text{m/s})`.
   ...
   * - 
     ...
     - | ``auxtel/atdome/home_dome.py``
       | `ts_standardscripts/atdome/home_dome.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/home_dome.py>`_
     -  
       .. dropdown:: SAL Script
   ...
   * - 
     ...
     - | ``auxtel/atdome/slew_dome.py``
       | `ts_standardscripts/atdome/slew_dome.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/slew_dome.py>`_
     -  
       .. dropdown:: SAL Script
   ...
   * - **ATDomeTrajectory**
     ...
     - | **Enable:**
       ...
       | `ts_standardscripts/atdome/enable_dome_following.py  <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/enable_dome_following.py>`_
       | **Disable:**
       | ``auxtel/atdome/disable_dome_following.py``
       | `ts_standardscripts/atdome/disable_dome_following.py  <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/atdome/disable_dome_following.py>`_
     -        
       .. dropdown:: SAL Script
   ...
   * - **ATAOS**
     ...
     - | **Enable:**
       ...
       | `ts_standardscripts/data/scripts/auxtel/enable_ataos_corrections.py  <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/enable_ataos_corrections.py>`_
       |
       | **Disable:**
       | ``auxtel/disable_ataos_corrections.py``
       | `ts_standardscripts/data/scripts/auxtel/disable_ataos_corrections.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/disable_ataos_corrections.py>`_
   ...
   * - 
     ...
     - | ``auxtel/offset_ataos.py``
       | `ts_standardscripts/data/scripts/auxtel/offset_ataos.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/offset_ataos.py>`_
     -  
       .. dropdown:: SAL Script
...
.. list-table::
   ...
   * - 
     ...
     - | **Enable:** 
       ...
       | `ts_standardscripts/data/scripts/auxtel/enable_latiss.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/enable_latiss.py>`_
       |
       | **Standby:** 
       | ``auxtel/standby_latiss.py``
       | `ts_standardscripts/data/scripts/auxtel/standby_latiss.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/standby_latiss.py>`_
     - No configurations
   * - **ATCamera**
     - Take image with camera
     - | ``auxtel/take_image_latiss.py``
       | `ts_standardscripts/data/scripts/auxtel/take_image_latiss.py  <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/take_image_latiss.py>`_
     -  
       .. dropdown:: SAL Script
...
.. list-table::
   ...
   * - **ATWhiteLight**
     ...
     - | **Turn On:**
       ...
       | `ts_standardscripts/calibrations/power_on_atcalsys.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/calibrations/power_on_atcalsys.py>`_
       |
       | **Turn Off:**
       | ``auxtel/calibration/power_off_atcalsys.py``
       | `ts_standardscripts/calibrations/power_off_atcalsys.py <https://github.com/lsst-ts/ts_auxtel_standardscripts/tree/develop/python/lsst/ts/auxtel/standardscripts/calibrations/power_off_atcalsys.py>`_
     - 
       .. dropdown:: SAL Script
