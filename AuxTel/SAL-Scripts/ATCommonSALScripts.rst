...
.. |contributors| replace:: *Karla Peña, Ioana Sotuela Elorriaga*
...
#################################################
Common SAL Scripts & Configurations
#################################################
   ...
   * - **Scheduler.2**
     ...
     -
       .. dropdown:: SAL Script
         ...
         The scripts ``resume.py`` and ``stop.py`` require No configurations. However, ``enable.py`` may require various ``.yaml`` files for configuration.
...
.. list-table::
   ...
   * - **ATAOS**
     ...
     - | **Enable:**
       ...
       .. warning::
         Only run these commands when the telescope pointing is at high elevation.
