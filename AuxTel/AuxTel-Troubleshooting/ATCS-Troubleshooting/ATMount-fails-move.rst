...
.. _ATCS-Troubleshooting-AuxTel-Mount-Fails-to-Move-Procedure-Overview:
...
.. _ATCS-Troubleshooting-AuxTel-Mount-Fails-to-Move-Procedure-Error-Diagnosis:
...
.. code-block:: text
  :caption: Traceback Error
   ...
   Fault event in ATMCS while in tracking enable state.  Azimuth max velocity error  exceeded. ATMCS Real-Time Application.vi/MOUNTDEV.vi/Generic Device.lvclass:Run.vi:1530004/MOUNTDEV.lvclass:NormalDeviceLogic.vi/MOUNTDEV.lvclass:ProcessDeviceLogicStateTransitions.vi/MntcTrackEnabledState.lvclass:ProcessStateTransition.vi/mount_fault_state_procedure.vi
   Fault event in ATMCS while in tracking enable state.  Azimuth drive #2 fault bit is ON.  Azimuth drive #1 fault bit is ON.  Azimuth max velocity error  exceeded. ATMCS Real-Time Application.vi/MOUNTDEV.vi/Generic Device.lvclass:Run.vi:1530004/MOUNTDEV.lvclass:NormalDeviceLogic.vi/MOUNTDEV.lvclass:ProcessDeviceLogicStateTransitions.vi/MntcTrackEnabledState.lvclass:ProcessStateTransition.vi/mount_fault_state_procedure.vi
.. 

.. _ATCS-Troubleshooting-AuxTel-Mount-Fails-to-Move-Procedure-Procedure-Steps:
...
#. Slew the telescope in small increments using the :file:`auxtel/point_azel.py` script.
   ...
   b. Start with azimuth and elevation coordinates close to the current position, from Az= 57.64 deg move to Az=58.00 deg.
