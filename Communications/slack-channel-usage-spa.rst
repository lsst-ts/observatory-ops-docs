...
##################################################
Comunicaciones en Slack con el Personal del Cerro
##################################################
...
- Este canal está dedicado a actividades específicas del cerro. 
  Los anuncios para las actividades en otros bancos de prueba deben realizarse en los canales específicos de esos bancos de prueba, siguiendo las mismas reglas detalladas arriba, es decir, #rubinobs-tucson-teststand y #rubinobs-base-teststand.
