...
Please always keep the list of :ref:`emergency numbers <summit-contact-numbers-emergency-numbers>` handy for any emergencies.
...
The instructions for entering AuxTel during the day are described below.

1. **Conditional access**
   
   - Ensure that no images are being taken and no work is being done in the AT dome that might be disrupted upon entering the telescope.
...
The procedures for entering AuxTel during ventilation periods are described below.
...
3. **Emergency Procedures**
   ...
   - In case of emergency, notify immediately via radio channel
...
Below are the guidelines for entering the AuxTel telescope during nighttime operations.
